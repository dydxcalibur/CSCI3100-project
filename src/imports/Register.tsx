    ...
    <div className="content-stretch flex flex-col gap-[24px] items-center justify-end relative shrink-0">
      <div className="box-border content-stretch flex gap-[10px] items-start p-[2px] relative shrink-0" data-name="Have an account login">
        <p className="font-['Poppins:Regular',sans-serif] leading-[normal] not-italic opacity-75 relative shrink-0 text-[#666666] text-[0px] text-[16px] text-nowrap whitespace-pre">
          <span className="text-white">Already have an account?</span> <span className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-['Poppins:Medium',sans-serif] text-[#fff41d] underline">{`Log in  `}</span>
        </p>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[48px] items-start left-[430px] top-[269px]">
      <Frame8 />
    </div>
  );
}
...
export default function Register() {
  return (
    <div className="bg-gradient-to-b from-[rgba(0,0,0,0.2)] relative size-full to-[rgba(114,110,20,0.2)]" data-name="register">
